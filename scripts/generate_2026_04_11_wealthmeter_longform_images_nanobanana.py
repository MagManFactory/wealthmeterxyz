#!/usr/bin/env python3
"""Generate Nano Banana Pro visuals for the 2026-04-11 WealthMeter longform article."""
...
ARTIFACT_DIR = ROOT / "output" / "review" / "longform-pair-2026-04-11" / "wealthmeter-nanobanana"
...
PROMPTS: list[dict[str, str]] = [
    {
        "name": "indexing-saturation-pressure-map.png",
        "title": "Indexing Saturation Pressure Map",
        "prompt": (
            "Create a 16:9 editorial systems infographic titled "
            "'The Indexing Saturation Problem'. "
            "Use a systems map with a central circle labeled 'cap-weighted benchmark'. "
            "Feed into it four upstream arrows labeled 'retirement contributions', 'ETF inflows', "
            "'advisor default allocation', and 'benchmarked institutional capital'. "
            "From the center send arrows to four downstream boxes labeled 'mega-cap price pressure', "
            "'higher co-movement', 'governance concentration', and 'household hidden overlap'. "
            "Add a side note box reading 'indexing solved cost and behavior first; concentration emerges later as a structure problem'. "
            "Use blue and teal with one amber warning accent on the mega-cap pressure box."
        ),
    },
    {
        "name": "index-concentration-governance-grid.png",
        "title": "Index Concentration Governance Grid",
        "prompt": (
            "Create a 16:9 comparison grid titled "
            "'What Indexing Still Solves and What It Does Not'. "
            "Use three columns labeled 'household benefit', 'structural side effect', and 'practical response'. "
            "Add five rows labeled 'fees', 'manager selection', 'benchmark concentration', 'governance centralization', and 'labor-income overlap'. "
            "Populate the cells with short readable phrases such as "
            "'low cost', 'top holdings dominate returns', 'measure top-ten exposure'; "
            "'no manager picking', 'stewardship power consolidates', 'review voting concentration'; "
            "'easy discipline', 'same names repeat across account types', 'offset with non-overlapping exposures'. "
            "Footer note: 'Broad fund count is not the same thing as broad economic exposure.'"
        ),
    },
]
