#!/usr/bin/env python3
"""Generate Nano Banana Pro visuals for the 2026-04-18 WealthMeter topic-1 refresh."""
...
ARTIFACT_DIR = ROOT / "output" / "review" / "longform-pair-2026-04-18" / "wealthmeter-nanobanana"
...
PROMPTS: list[dict[str, str]] = [
    {
        "name": "liquidity-stress-haircut-ladder-2026-refresh.png",
    ...
    {
        "name": "liquidity-deadline-control-map-2026-refresh.png",
        "title": "Liquidity Deadline Control Map",
        "prompt": (
            "Create a 16:9 editorial timeline titled 'Liquidity Changes Who Controls The Clock'. Show a household shock running from 'income break or relocation need' to '30 days', '90 days', and '180 days'. Compare two tracks labeled 'owned liquidity' and 'conditional liquidity'. End the owned-liquidity track with outcome boxes labeled 'negotiate', 'wait', 'move', and 'avoid forced sale'. End the conditional-liquidity track with 'sell early', 'borrow high', 'refinance under pressure', and 'delay decision'. Keep the visual institutional, minimal, and highly legible."
        ),
    },
]
