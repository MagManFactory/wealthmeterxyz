#!/usr/bin/env python3
"""Generate Nano Banana Pro visuals for the 2026-04-01 WealthMeter longform article.

Usage:
  GOOGLE_API_KEY=... python3 scripts/generate_2026_04_01_wealthmeter_longform_images_nanobanana.py
  python3 scripts/generate_2026_04_01_wealthmeter_longform_images_nanobanana.py --api-key "<GOOGLE_API_KEY>"
"""
...
ARTIFACT_DIR = ROOT / "output" / "review" / "longform-pair-2026-04-01" / "wealthmeter-nanobanana"
...
PROMPTS: list[dict[str, str]] = [
    {
        "name": "liquidity-illusion-balance-sheet-map.png",
        "title": "Liquidity Illusion Balance Sheet Map",
        "prompt": (
            "Create a 16:9 executive infographic titled "
            "'The Liquidity Illusion'. "
            "Show a horizontal spectrum from 'usable today' to 'slow or conditional wealth'. "
            "Place boxes along the spectrum labeled 'cash and checking', 'high-quality brokerage assets', "
            "'retirement accounts', 'home equity', and 'private business equity'. "
            "Below each box add a short note about access friction such as 'immediate', 'sale and tax aware', "
            "'penalty or architecture damage', 'loan or sale required', and 'buyer dependent'. "
            "Bottom caption: 'Net worth measures ownership. Liquidity measures response capacity.'"
        ),
    },
    {
        "name": "liquidity-stress-tier-framework.png",
        "title": "Liquidity Stress Tier Framework",
        "prompt": (
            "Create a 16:9 systems infographic titled "
            "'How Assets Convert Under Stress'. "
            "Use four stacked tiers labeled 'Tier 1 immediate reserves', 'Tier 2 marketable assets', "
            "'Tier 3 penalty-bearing assets', and 'Tier 4 slow private wealth'. "
            "To the right of each tier show timing labels 'hours', 'days', 'weeks', and 'months or contingent'. "
            "Add small warning tags reading 'tax drag', 'forced-sale risk', 'borrowing spread', and 'option-value loss'. "
            "Editorial white background, crisp hierarchy, no decorative clutter."
        ),
    },
]
