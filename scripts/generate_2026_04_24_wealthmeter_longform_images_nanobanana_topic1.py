#!/usr/bin/env python3
"""Generate Nano Banana Pro visuals for the 2026-04-24 WealthMeter topic-1 refresh."""
...
PROMPTS: list[dict[str, str]] = [
    {
        "name": "liquidity-stress-haircut-ladder-2026-apr24.png",
        "title": "Liquidity Stress Haircut Ladder",
        "prompt": (
            "Create a 16:9 editorial ladder diagram titled 'Balance-Sheet Value Shrinks Under Deadline Stress'. Use six horizontal layers labeled 'cash', 'Treasury-like reserves', 'taxable diversified securities', 'collateralized borrowing access', 'retirement accounts', and 'home or private business value'. For each layer show compact columns labeled 'speed', 'haircut', and 'second-order cost'. Use blue for strong conversion quality, slate for moderate quality, and restrained amber for costly or conditional conversion."
        ),
    },
    {
        "name": "liquidity-deadline-control-map-2026-apr24.png",
        "title": "Liquidity Deadline Control Map",
        "prompt": (
            "Create a 16:9 editorial timeline titled 'Liquidity Changes Who Controls The Clock'. Show a household shock running from 'income break or relocation need' to '30 days', '90 days', and '180 days'. Compare two tracks labeled 'owned liquidity' and 'conditional liquidity'. End the owned-liquidity track with outcome boxes labeled 'negotiate', 'wait', 'move', and 'avoid forced sale'. End the conditional-liquidity track with 'sell early', 'borrow high', 'refinance under pressure', and 'delay decision'. Add a compact note that owned liquidity preserves option value while conditional liquidity rents time. Keep the visual institutional, minimal, and highly legible."
        ),
    },
]
