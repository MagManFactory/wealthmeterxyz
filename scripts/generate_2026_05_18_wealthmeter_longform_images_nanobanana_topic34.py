#!/usr/bin/env python3
"""Generate Nano Banana Pro visuals for the 2026-05-18 WealthMeter topic-34 article."""
...
ARTIFACT_DIR = ROOT / "output" / "review" / "longform-pair-2026-05-18" / "wealthmeter-nanobanana"
...
PROMPTS: list[dict[str, str]] = [
    {
        "name": "risk-tolerance-capacity-stack-2026-may18.png",
        "title": "Risk Tolerance Capacity Stack",
        "prompt": (
            "Create a 16:9 editorial stacked framework titled "
            "'Risk Tolerance Is Three Different Questions'. "
            "Show three horizontal layers labeled 'willingness', 'need', and 'capacity'. "
            "Under each layer add compact factors such as 'emotion', 'return target', 'liquidity', "
            "'leverage', and 'income stability'. "
            "Add a footer note reading 'questionnaires usually capture only one layer'."
        ),
    },
    {
        "name": "drawdown-behavior-gap-grid-2026-may18.png",
        "title": "Drawdown Behavior Gap Grid",
        "prompt": (
            "Create a 16:9 editorial comparison grid titled "
            "'What Investors Say vs What Drawdowns Force'. "
            "Use columns labeled 'calm market claim', 'real drawdown response', and 'household consequence'. "
            "Use rows labeled 'concentrated equity', 'illiquid real estate', 'leveraged plan', and 'cash-thin household'. "
            "Keep the labels large and publication-ready. "
            "Add a side note reading 'capacity is tested when losses meet life constraints'."
        ),
    },
]
