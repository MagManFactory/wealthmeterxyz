#!/usr/bin/env python3
"""Generate Nano Banana Pro visuals for the 2026-05-03 WealthMeter topic-23 article."""
...
ARTIFACT_DIR = ROOT / "output" / "review" / "longform-pair-2026-05-03" / "wealthmeter-nanobanana"
...
PROMPTS: list[dict[str, str]] = [
    {
        "name": "rebalancing-illusion-flow-2026-may03.png",
        "title": "Rebalancing Illusion Flow",
        "prompt": (
            "Create a 16:9 editorial process diagram titled "
            "'Why Rebalancing On Paper Differs From Rebalancing In Real Portfolios'. "
            "Use a left-to-right flow with seven stages labeled 'target weights', 'market drift', "
            "'rebalance trigger', 'tax cost', 'spreads and slippage', 'behavior override', and "
            "'realized portfolio outcome'. "
            "Add small sublabels such as 'embedded gains', 'single-stock attachment', "
            "'calendar rule', and 'cash-flow alternative'. "
            "Footer: 'Governance value is real. Automatic wealth magic is not.'"
        ),
    },
    {
        "name": "rebalancing-illusion-decision-grid-2026-may03.png",
        "title": "Rebalancing Illusion Decision Grid",
        "prompt": (
            "Create a 16:9 editorial decision grid titled "
            "'When Rebalancing Helps And When It Becomes Ritual'. "
            "Use a 2x2 matrix. Horizontal axis: 'policy quality weak' to 'policy quality strong'. "
            "Vertical axis: 'friction high' to 'friction low'. "
            "Label quadrants 'tax trap', 'clean maintenance', 'false precision', and 'disciplined reset'. "
            "Add short callouts such as 'threshold bands', 'new cash first', 'illiquid holdings', "
            "'calendar myth', and 'concentration creep'. "
            "Footer: 'The right rule depends on taxes, liquidity, and behavior.'"
        ),
    },
]
