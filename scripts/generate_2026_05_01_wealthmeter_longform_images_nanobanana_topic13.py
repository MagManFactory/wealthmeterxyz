#!/usr/bin/env python3
"""Generate Nano Banana Pro visuals for the 2026-05-01 WealthMeter topic-13 article."""
...
ARTIFACT_DIR = ROOT / "output" / "review" / "longform-pair-2026-05-01" / "wealthmeter-nanobanana"
...
PROMPTS: list[dict[str, str]] = [
    {
        "name": "skill-obsolescence-half-life-2026-may01.png",
        "title": "Skill Obsolescence Half-Life Curve",
        "prompt": (
            "Create a 16:9 editorial curve graphic titled "
            "'The Skill Obsolescence Curve'. "
            "Show three lines across time: a dark blue line labeled 'frontier skill value' that stays high, "
            "a slate line labeled 'legacy skill value' that declines, and a muted red line labeled 'household obligations' that stays flat to slightly rising. "
            "Place a highlighted gap between declining legacy skill value and obligations with the label 'optionality squeeze'. "
            "Add small callouts reading 'retraining lag', 'outside offers weaken', and 'salary looks stable until repricing arrives'."
        ),
    },
    {
        "name": "skill-obsolescence-income-shield-grid-2026-may01.png",
        "title": "Skill Obsolescence Income Shield Grid",
        "prompt": (
            "Create a 16:9 editorial matrix titled "
            "'What Protects Income When Skills Reprice'. "
            "Use four columns labeled 'liquidity runway', 'active retraining', 'outside market signal', and 'fixed-cost burden'. "
            "Use three rows labeled 'frontier worker', 'comfortable incumbent', and 'stressed late adapter'. "
            "Fill the cells with concise phrases such as 'selective search', 'stack compounds', 'offer spread real', 'forced acceptance', "
            "'legacy title only', 'reskill under pressure', and 'salary defense weak'."
        ),
    },
]
