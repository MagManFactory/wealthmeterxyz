#!/usr/bin/env python3
"""Generate Nano Banana Pro visuals for the 2026-04-16 WealthMeter longform article."""
...
ARTIFACT_DIR = ROOT / "output" / "review" / "longform-pair-2026-04-16" / "wealthmeter-nanobanana"
...
PROMPTS: list[dict[str, str]] = [
    {
        "name": "asset-rich-cash-poor-balance-sheet-map-2026-refresh.png",
        "title": "Asset Rich Cash Poor Balance Sheet Map",
        "prompt": (
            "Create a 16:9 editorial balance-sheet map titled "
            "'Asset Rich, Cash Poor'. "
            "Show four horizontal layers from top to bottom: 'cash and near cash', "
            "'marketable taxable assets', 'retirement and tax-advantaged assets', and "
            "'home equity and private business value'. "
            "On the right add a compact indicator bar for each layer with 'speed', 'friction', and 'shock defense'. "
            "Use blue and slate for stronger liquidity and restrained amber for weak shock defense. "
            "Keep the layout crisp, institutional, and very legible."
        ),
    },
    {
        "name": "asset-rich-cash-poor-optionality-gap-2026-refresh.png",
        "title": "Asset Rich Cash Poor Optionality Gap",
        "prompt": (
            "Create a 16:9 editorial flowchart titled "
            "'How Illiquid Wealth Narrows Household Choice'. "
            "Begin with a box labeled 'paper wealth rises' leading to branches for 'higher fixed costs', "
            "'thin cash buffer', and 'conditional borrowing'. "
            "End with outcome boxes labeled 'delay relocation', 'reject career move', 'forced sale risk', "
            "and 'borrow against tomorrow'. Use a minimalist institutional infographic style with large readable labels."
        ),
    },
]
