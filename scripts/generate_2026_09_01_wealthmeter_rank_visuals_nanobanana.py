...
PROMPTS: list[dict[str, str]] = [
    {
        "name": "mean-median-wealth-gap-2026-sep01.png",
        "title": "Mean and Median Wealth Gap",
        "prompt": (
            "Create a 16:9 editorial distribution chart titled 'Why Mean Wealth Can Be High While Median Wealth Stays Modest'. "
            "Show a long right-tail wealth distribution, a median marker in the middle, and a mean marker pulled toward the tail. "
            "Include concise labels 'middle household', 'upper tail', and 'mean rises with concentrated assets'."
        ),
    },
    {
        "name": "wealth-rank-audit-2026-sep01.png",
        "title": "Wealth Rank Audit",
        "prompt": (
            "Create a 16:9 editorial decision framework titled 'A Wealth Rank Is Context, Not A Plan'. "
            "Show five sequential audit blocks labeled 'peer group', 'net worth', 'liquid reserves', 'debt burden', and 'optionality'. "
            "End with two outcomes labeled 'ranking claim' and 'household resilience'. Keep the graphic minimal and legible."
        ),
    },
]
