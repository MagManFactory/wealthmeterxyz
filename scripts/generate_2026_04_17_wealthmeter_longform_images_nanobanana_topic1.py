#!/usr/bin/env python3
"""Generate Nano Banana Pro visuals for the 2026-04-17 WealthMeter topic-1 refresh."""
...
ARTIFACT_DIR = ROOT / "output" / "review" / "longform-pair-2026-04-17" / "wealthmeter-nanobanana"
...
PROMPTS: list[dict[str, str]] = [
    {
        "name": "liquidity-conversion-haircut-ladder-2026.png",
        "title": "Liquidity Conversion Haircut Ladder",
        "prompt": (
            "Create a 16:9 editorial ladder diagram titled "
            "'Headline Net Worth Shrinks Fast Under Real Conversion Haircuts'. "
            "Use six horizontal steps labeled 'cash', 'Treasury-like reserves', 'taxable diversified securities', "
            "'collateralized borrowing access', 'retirement accounts', and 'home or private business value'. "
            "For each step show three compact columns: 'time to use', 'expected haircut', and 'side effect'. "
    ...
    {
        "name": "liquidity-option-value-timeline-2026.png",
        "title": "Liquidity Option Value Timeline",
        "prompt": (
            "Create a 16:9 editorial timeline titled "
            "'Liquidity Matters Because Deadlines Destroy Choice'. "
            "Show a household shock timeline from 'job loss or relocation need' to '30 days', '90 days', and '180 days'. "
            "Across the timeline compare two tracks: 'owned liquidity' and 'conditional liquidity'. "
            "End with outcome boxes labeled 'negotiate', 'wait', 'move', and 'avoid forced sale' for the owned-liquidity track, "
            "and 'sell early', 'borrow high', and 'delay decision' for the conditional-liquidity track. "
