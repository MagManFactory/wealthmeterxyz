#!/usr/bin/env python3
"""Generate Nano Banana Pro visuals for the 2026-05-17 WealthMeter topic-29 article."""
...
ARTIFACT_DIR = ROOT / "output" / "review" / "longform-pair-2026-05-17" / "wealthmeter-nanobanana"
...
PROMPTS: list[dict[str, str]] = [
    {
        "name": "urban-premium-spread-collapse-2026-may17.png",
        "title": "Urban Premium Spread Collapse",
        "prompt": (
            "Create a 16:9 editorial waterfall chart titled "
            "'The Urban Premium Collapse'. "
            "Start with a high nominal city salary bar, then subtract labeled segments for 'housing', 'taxes', "
            "'commuting', 'childcare and services', and 'time cost'. "
            "End with a much smaller bar labeled 'investable surplus'. "
            "Add a short footer note reading 'gross pay is not the same as durable wealth'."
        ),
    },
    {
        "name": "urban-optionality-triangle-2026-may17.png",
        "title": "Urban Optionality Triangle",
        "prompt": (
            "Create a 16:9 editorial triangle diagram titled "
            "'Salary, Housing Burden, and Mobility'. "
            "Use three corners labeled 'higher pay', 'lower housing load', and 'career flexibility'. "
            "Place small household scenarios along the triangle such as 'city climber', 'remote optimizer', and 'housing locked'. "
            "Include a side note that reads 'few households maximize all three at once'."
        ),
    },
]
