#!/usr/bin/env python3
"""Generate Nano Banana Pro visuals for the 2026-04-10 WealthMeter longform article."""
...
ARTIFACT_DIR = ROOT / "output" / "review" / "longform-pair-2026-04-10" / "wealthmeter-nanobanana"
...
PROMPTS: list[dict[str, str]] = [
    {
        "name": "golden-handcuffs-retention-equation.png",
        "title": "Golden Handcuffs Retention Equation",
        "prompt": (
            "Create a 16:9 editorial systems infographic titled "
            "'The Golden Handcuffs Equation'. "
            "Use a centered equation layout with a bold output box reading 'retention pressure'. "
            "On the left side stack positive inputs labeled 'base salary premium', "
            "'unvested equity', 'bonus timing', 'health-benefit lock', and 'retirement match'. "
            "On the right side show subtractors labeled 'cash runway', 'outside offers', "
            "'benefit portability', and 'liquid household reserves'. "
            "Use blue blocks for compensation terms and amber blocks for constraint terms. "
            "Add a small caption under the output box: 'High pay does not equal high freedom.'"
        ),
    },
    {
        "name": "golden-handcuffs-exit-cost-stack.png",
        "title": "Golden Handcuffs Exit Cost Stack",
        "prompt": (
            "Create a 16:9 stacked cost diagram titled "
            "'What Leaving Actually Costs'. "
            "Use six layers labeled 'forfeited RSUs and options', 'lost bonus cycle', "
            "'health insurance replacement', 'tax timing friction', 'job-search income gap', "
            "and 'sector concentration reset'. "
            "Place a side bracket labeled 'household resilience' next to the full stack. "
            "At the bottom add a base strip labeled 'liquid cash runway decides whether the stack is survivable'. "
            "Footer note: 'The trap is strongest when future employer-controlled value has replaced present liquidity.'"
        ),
    },
]
