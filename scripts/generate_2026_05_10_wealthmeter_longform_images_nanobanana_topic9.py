#!/usr/bin/env python3
"""Generate Nano Banana Pro visuals for the 2026-05-10 WealthMeter topic-9 article."""
...
ARTIFACT_DIR = ROOT / "output" / "review" / "longform-pair-2026-05-10" / "wealthmeter-nanobanana"
...
PROMPTS = [
    {
        "name": "salary-ceiling-income-ladder-2026-may10.png",
        "title": "Salary Ceiling Income Ladder",
        "prompt": (
            "Create a 16:9 editorial ladder chart titled 'The Salary Ceiling Illusion'. "
            "Show five rungs labeled 'career entry', 'mid-career acceleration', 'manager band', 'senior leadership', and 'rare peak packages'. "
            "Beside the ladder, add three descending side bars labeled 'promotion odds', 'after-tax conversion', and 'role replaceability'. "
            "Use blue on lower rungs, amber in the middle, and red near the top where the caption reads 'gross income rises faster than optionality'."
        ),
    },
    {
        "name": "salary-conversion-bottleneck-map-2026-may10.png",
        "title": "Salary Conversion Bottleneck Map",
        "prompt": (
            "Create a 16:9 editorial flow map titled 'Where Salary Stops Becoming Wealth'. "
            "Start with a left block labeled 'gross salary' and send the flow through bottlenecks labeled 'tax drag', 'housing and geography', 'benefit dependence', 'childcare or schooling', 'debt service', and 'status overhead'. "
            "End with a smaller right block labeled 'durable asset formation'. "
            "Add a footer note reading 'throughput is not the same as strategic autonomy'."
        ),
    },
]
