#!/usr/bin/env python3
"""Generate Nano Banana Pro visuals for the 2026-04-30 WealthMeter topic-8 article."""
...
ARTIFACT_DIR = ROOT / "output" / "review" / "longform-pair-2026-04-30" / "wealthmeter-nanobanana"
...
PROMPTS: list[dict[str, str]] = [
    {
        "name": "wealth-plateau-compounding-curve-2026-apr30.png",
        "title": "Wealth Plateau Compounding Curve",
        "prompt": (
            "Create a 16:9 editorial curve diagram titled 'The Wealth Plateau Effect'. "
            "Show a strong rising line labeled 'early income conversion' that begins to flatten into a plateau labeled "
            "'more value, less optionality'. Add four drag blocks pressing down on the flattening section: "
            "'housing concentration', 'retirement lockups', 'tax friction', and 'fixed-cost expansion'. "
            "Footer: 'The plateau starts when each new dollar reaches the balance sheet in a slower and less flexible form.'"
        ),
    },
    {
        "name": "wealth-plateau-balance-sheet-grid-2026-apr30.png",
        "title": "Wealth Plateau Balance Sheet Grid",
        "prompt": (
            "Create a 16:9 editorial matrix titled 'Which Assets Deepen Freedom?'. "
            "Use rows for 'cash runway', 'taxable equities', 'retirement accounts', 'home equity', and 'business equity'. "
            "Use columns for 'liquidity', 'tax friction', 'shock absorption', and 'growth optionality'. "
            "Fill each cell with short phrases such as 'immediate', 'low friction', 'locked until event', 'borrow against only', "
            "'high upside but volatile', and 'strong future security, weak present flexibility'. "
            "Highlight taxable flexible capital with blue emphasis and constrained wealth with amber emphasis."
        ),
    },
]
