#!/usr/bin/env python3
"""Generate Nano Banana Pro visuals for the 2026-05-15 WealthMeter topic-24 article."""
...
ARTIFACT_DIR = ROOT / "output" / "review" / "longform-pair-2026-05-15" / "wealthmeter-nanobanana"
...
PROMPTS: list[dict[str, str]] = [
    {
        "name": "cash-opportunity-cost-ladder-2026-may15.png",
        "title": "Cash Opportunity Cost Ladder",
        "prompt": (
            "Create a 16:9 editorial ladder diagram titled "
            "'The Opportunity Cost of Cash'. "
            "Show five stacked layers labeled 'checking cash', 'money market and T-bills', "
            "'short-duration reserves', 'diversified compounding assets', and 'higher-return strategic uses'. "
            "Alongside each layer show compact tags for 'liquidity', 'stability', and 'expected long-run return'. "
            "At the bottom add a footer note reading 'cash is cheap only when the optionality it buys is real'."
        ),
    },
    {
        "name": "cash-optionality-vs-compounding-grid-2026-may15.png",
        "title": "Cash Optionality vs Compounding Grid",
        "prompt": (
            "Create a 16:9 editorial two-axis grid titled "
            "'When Cash Is Rational and When It Is Costly'. "
            "Use the horizontal axis 'optionality value' from low to high and the vertical axis 'forgone compounding cost' from low to high. "
            "Label the four quadrants 'safe to hold', 'temporary reserve', 'costly indecision', and 'cash with a mission'. "
            "Place small callouts such as 'emergency fund', 'tax payment', 'unallocated fear cash', and 'planned deployment'."
        ),
    },
]
