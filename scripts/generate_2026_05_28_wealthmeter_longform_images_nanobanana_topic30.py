#!/usr/bin/env python3
"""Generate Nano Banana Pro visuals for the 2026-05-28 WealthMeter topic-30 article."""
...
ARTIFACT_DIR = ROOT / "output" / "review" / "longform-pair-2026-05-28" / "wealthmeter-nanobanana"
...
PROMPTS: list[dict[str, str]] = [
    {
        "name": "property-tax-carry-stack-2026-may28.png",
        "title": "Property Tax Carry Stack",
        "prompt": (
            "Create a 16:9 editorial stack diagram titled "
            "'Homeownership Carry Does Not End With the Mortgage'. "
            "Show layered blocks labeled 'mortgage or debt service', 'property tax', 'insurance', "
            "'maintenance', and 'utilities and local fees'. "
            "Visually emphasize the property-tax layer as a recurring holding cost. "
            "Add a footer note reading 'paid off is not the same as free to hold'."
        ),
    },
    {
        "name": "property-tax-friction-map-2026-may28.png",
        "title": "Property Tax Friction Map",
        "prompt": (
            "Create a 16:9 editorial systems map titled "
            "'How Property Tax Turns Into Household Friction'. "
            "Start with left-side inputs labeled 'assessed value', 'local budgets', 'reassessment rules', and 'insurance inflation'. "
            "Route them through middle nodes labeled 'annual carrying cost', 'retirement cash pressure', and 'mobility drag'. "
            "End with right-side outcomes labeled 'reduced optionality', 'asset-rich cash strain', and 'weaker real housing yield'."
        ),
    },
]
