#!/usr/bin/env python3
"""Generate Nano Banana Pro visuals for the 2026-04-17 WealthMeter longform article."""
...
PROMPTS: list[dict[str, str]] = [
    {
        ...
        "title": "Cost of Capital Hurdle Stack Refresh",
        "prompt": (
            "Create a 16:9 editorial stack diagram titled "
            "'The Real Cost Of Capital'. "
            "Use six clean horizontal layers labeled "
            "'headline rate', 'credit spread or equity premium', 'tax drag', "
            "'fees and maintenance carry', 'liquidity lock-up', and 'refinancing or exit risk'. "
            "Place three side callouts pointing to the full stack labeled "
            "'housing', 'private funds', and 'operating business capital'. "
            "Add a footer line reading 'Assets fail when returns clear the sticker price but not the full hurdle.'"
        ),
    },
    {
        "name": "cost-of-capital-allocation-grid.png",
        "title": "Cost of Capital Allocation Grid Refresh",
        "prompt": (
            "Create a 16:9 editorial matrix titled "
            "'What Actually Clears The Hurdle?'. "
            ...
            "Inside the trap zone include concise labels 'illusory yield', 'lock-up', 'weak exit market', and 'spread disappears after carry'. "
            "Inside the genuine spread zone include 'liquid enough', 'after-tax edge', and 'durable cash generation'. "
            "Keep the layout crisp, calm, and highly legible."
        ),
    },
]
