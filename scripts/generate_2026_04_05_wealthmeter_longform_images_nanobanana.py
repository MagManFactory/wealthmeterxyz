#!/usr/bin/env python3
"""Generate Nano Banana Pro visuals for the 2026-04-05 WealthMeter longform article."""
...
ARTIFACT_DIR = ROOT / "output" / "review" / "longform-pair-2026-04-05" / "wealthmeter-nanobanana"
...
PROMPTS: list[dict[str, str]] = [
    {
        "name": "overconfidence-cycle-feedback-loop.png",
        "title": "Overconfidence Cycle Feedback Loop",
        "prompt": (
            "Create a 16:9 editorial systems infographic titled "
            "'The Overconfidence Cycle'. "
            "Use a circular feedback-loop layout with six stages labeled 'recent gains', "
            "'self-attribution', 'higher conviction', 'larger positions', 'weaker diversification', "
            "and 'larger drawdown when wrong'. Add a thin side annotation band with 'turnover rises', "
            "'cash buffers shrink', and 'exit rules soften'. Footer note: 'The cost of the next error rises after each success misread as skill.'"
        ),
    },
    {
        "name": "overconfidence-portfolio-drift-grid.png",
        "title": "Overconfidence Portfolio Drift Grid",
        "prompt": (
            "Create a 16:9 decision grid titled "
            "'How Confidence Becomes Fragility'. "
            "Use a 2x2 matrix. Horizontal axis: 'process discipline strong' to 'process discipline weak'. "
            "Vertical axis: 'self-rated edge low' to 'self-rated edge high'. "
            "Top-left quadrant label: 'calibrated restraint'. "
            "Top-right quadrant label: 'premature conviction' with notes 'faster trading', 'story-led sizing'. "
            "Bottom-left quadrant label: 'slow but robust'. "
            "Bottom-right quadrant label: 'portfolio drift zone' with notes 'concentration', 'tax drag', 'reserve erosion'. "
            "Footer strip: 'Confidence becomes dangerous when it rewrites risk controls.'"
        ),
    },
]
