#!/usr/bin/env python3
"""Generate Nano Banana Pro visuals for the 2026-04-25 WealthMeter topic-31 refresh."""
...
ARTIFACT_DIR = ROOT / "output" / "review" / "longform-pair-2026-04-25" / "wealthmeter-nanobanana"
...
PROMPTS: list[dict[str, str]] = [
    {
        "name": "ownership-carry-system-stack-2026-apr25.png",
        "title": "Ownership Carry System Stack",
        "prompt": (
            "Create a 16:9 editorial infographic titled 'The Hidden Costs of Ownership'. "
            "Use a widening stacked diagram that begins with 'purchase price' and expands into "
            "'financing cost', 'property tax or registration', 'insurance', 'maintenance and repairs', "
            "'replacement reserve', 'transaction friction', and 'attention load'. "
            "Footer: 'Ownership is a carry system, not a one-time event.'"
        ),
    },
    {
        "name": "ownership-flexibility-friction-grid-2026-apr25.png",
        "title": "Ownership Flexibility Friction Grid",
        "prompt": (
            "Create a 16:9 decision grid titled 'When Ownership Strengthens or Weakens a Household'. "
            "Use a 2x2 matrix. Horizontal axis: 'fixed carry low' to 'fixed carry high'. "
            "Vertical axis: 'flexibility need low' to 'flexibility need high'. "
            "Quadrant labels: 'ownership can work', 'ownership requires deep reserves', "
            "'rent or lease may fit better', and 'ownership creates friction'. "
            "Add short notes such as 'long horizon', 'stable location', 'repair burden', and 'mobility risk'. "
            "Footer: 'Control is valuable only when the carry burden is absorbable.'"
        ),
    },
]
