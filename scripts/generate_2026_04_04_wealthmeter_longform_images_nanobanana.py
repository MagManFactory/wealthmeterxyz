#!/usr/bin/env python3
"""Generate Nano Banana Pro visuals for the 2026-04-04 WealthMeter longform article."""
...
ARTIFACT_DIR = ROOT / "output" / "review" / "longform-pair-2026-04-04" / "wealthmeter-nanobanana"
...
PROMPTS: list[dict[str, str]] = [
    {
        "name": "ownership-cost-stack-waterfall.png",
        "title": "Ownership Cost Stack Waterfall",
        "prompt": (
            "Create a 16:9 editorial infographic titled "
            "'The Hidden Costs of Ownership'. "
            "Use a waterfall-style layout starting with 'purchase price' and then stacking 'financing', 'property tax or registration', 'insurance', 'maintenance', 'repairs', 'replacement reserve', and 'transaction friction'. "
            "Add a side note saying 'headline price hides carry system'. "
            "Footer note: 'Ownership is an operating cost structure, not only a purchase event.'"
        ),
    },
    {
        "name": "ownership-optionality-tradeoff-grid.png",
        "title": "Ownership Optionality Tradeoff Grid",
        "prompt": (
            "Create a 16:9 decision grid titled "
            "'When Ownership Helps, and When It Traps'. "
            "Use a 2x2 matrix. Horizontal axis: 'time horizon short' to 'time horizon long'. "
            "Vertical axis: 'reserve strength weak' to 'reserve strength strong'. "
            "Top-left quadrant label: 'high fragility' with notes 'carry burden', 'exit friction'. "
            "Top-right quadrant label: 'conditional ownership' with notes 'long horizon helps', 'repairs still matter'. "
            "Bottom-left quadrant label: 'rent or delay' with notes 'optionalty more valuable'. "
            "Bottom-right quadrant label: 'ownership can compound' with notes 'stable fit', 'reserve depth', 'management capacity'. "
            "Footer strip: 'Control rises with ownership, but optionality can fall.'"
        ),
    },
]
