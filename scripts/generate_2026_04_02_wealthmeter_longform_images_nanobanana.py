#!/usr/bin/env python3
"""Generate Nano Banana Pro visuals for the 2026-04-02 WealthMeter longform article.

Usage:
  GOOGLE_API_KEY=... python3 scripts/generate_2026_04_02_wealthmeter_longform_images_nanobanana.py
  python3 scripts/generate_2026_04_02_wealthmeter_longform_images_nanobanana.py --api-key "<GOOGLE_API_KEY>"
"""
...
ARTIFACT_DIR = ROOT / "output" / "review" / "longform-pair-2026-04-02" / "wealthmeter-nanobanana"
...
PROMPTS: list[dict[str, str]] = [
    {
        "name": "concentration-diversification-barbell.png",
        "title": "Concentration Diversification Barbell",
        "prompt": (
            "Create a 16:9 editorial infographic titled "
            "'The Concentration vs Diversification Tradeoff'. "
            "Use a barbell composition. Left side labeled 'Diversified core' with concise notes "
            "'broad market exposure', 'high survivability', 'lower idiosyncratic risk'. "
            "Right side labeled 'Concentrated edge' with concise notes 'control or insight', 'higher upside', 'higher drawdown risk'. "
            "Center hinge label: 'Household balance sheet'. "
            "Under the hinge add four decision tags: 'edge', 'liquidity', 'human-capital overlap', 'exit discipline'. "
            "Footer note: 'Concentration only earns its place when the household can survive being wrong.'"
        ),
    },
    {
        "name": "concentration-edge-decision-grid.png",
        "title": "Concentration Edge Decision Grid",
        "prompt": (
            "Create a 16:9 decision matrix titled "
            "'When Concentration Is Rational'. "
            "Use a 2x2 grid. Horizontal axis: 'edge weak' to 'edge strong'. Vertical axis: 'liquidity thin' to 'liquidity strong'. "
            "Top-right quadrant label: 'possible concentration' with short notes 'clear edge', 'cash runway', 'exit rules'. "
            "Top-left quadrant label: 'diversify' with notes 'no edge, cash available'. "
            "Bottom-right quadrant label: 'reduce size' with notes 'edge may exist, runway too thin'. "
            "Bottom-left quadrant label: 'do not concentrate' with notes 'story risk, forced-sale risk'. "
            "Add a footer strip listing 'tax friction is not edge' and 'employer stock can duplicate labor risk'."
        ),
    },
]
