#!/usr/bin/env python3
"""Generate Nano Banana Pro visuals for the 2026-05-25 WealthMeter topic-15 article."""
...
PROMPTS: list[dict[str, str]] = [
    {
        "name": "freelance-freedom-cashflow-stack-2026-may25.png",
        "title": "Freelance Freedom Cashflow Stack",
        "prompt": (
            "Create a 16:9 editorial waterfall titled "
            "'Where Freelance Revenue Actually Goes'. "
            "Start with a large top block labeled 'gross billings' and step down through "
            "'self-employment tax reserve', 'health coverage', 'nonbillable business time', "
            "'tooling and admin', 'dry-month buffer', and 'investable surplus'. "
            "Keep labels bold and easy to read. "
            "Add a footer note reading 'freedom has an operating cost'."
        ),
    },
    {
        "name": "freelance-risk-buffer-grid-2026-may25.png",
        "title": "Freelance Risk Buffer Grid",
        "prompt": (
            "Create a 16:9 editorial comparison grid titled "
            "'Which Freelance Models Build Wealth and Which Stay Fragile'. "
            "Use columns labeled 'high-retainer specialist', 'project-based soloist', "
            "'single-client contractor', and 'platform-dependent freelancer'. "
            "Use rows labeled 'pricing power', 'client concentration', 'buffer need', and 'failure risk'. "
            "Add a side note reading 'independence depends on diversification and cash'."
        ),
    },
]
