#!/usr/bin/env python3
"""Generate Nano Banana Pro visuals for the 2026-08-28 WealthMeter home equity longform."""
...
ARTIFACT_DIR = ROOT / "output" / "review" / "longform-pair-2026-08-28" / "wealthmeter-nanobanana-home-equity"
...
PROMPTS: list[dict[str, str]] = [
    {
        "name": "home-equity-liquidity-timeline-2026-aug28.png",
        "title": "Home Equity Liquidity Timeline",
        "prompt": (
            "Create a 16:9 editorial timeline titled "
            "'Home Equity Does Not Move At Cash Speed'. "
            "Use four horizontal lanes labeled 'cash or checking', 'HELOC draw', 'cash-out refinance', and 'home sale'. "
            "For each lane show three markers labeled 'access speed', 'friction', and 'loss of control'. "
            "Make the cash lane short and clean, the HELOC lane medium with underwriting and repayment notes, "
            "the refinance lane longer with rate reset and closing cost notes, and the home sale lane longest with market timing, moving, and transaction cost notes. "
            "Add a footer line reading 'A large asset can still be the wrong asset for an emergency.'"
        ),
    },
    {
        "name": "home-equity-shock-waterfall-2026-aug28.png",
        "title": "Home Equity Shock Waterfall",
        "prompt": (
            "Create a 16:9 editorial waterfall diagram titled "
            "'What Happens When The Shock Arrives Before The Equity Converts'. "
            "Start with three incoming boxes labeled '$400 surprise', 'deductible cluster', and 'job loss'. "
            "Flow them into a central decision stack labeled 'owned cash', 'credit card float', 'HELOC or loan', 'refinance', and 'sale'. "
            "On the right, attach friction notes reading 'interest cost', 'approval risk', 'time delay', and 'housing disruption'. "
            "Use a crisp institutional style with large readable labels and restrained blue plus amber accents."
        ),
    },
]
