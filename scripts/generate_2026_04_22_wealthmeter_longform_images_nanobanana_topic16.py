#!/usr/bin/env python3
"""Generate Nano Banana Pro visuals for the 2026-04-22 WealthMeter topic-16 article."""
...
ARTIFACT_DIR = ROOT / "output" / "review" / "longform-pair-2026-04-22" / "wealthmeter-nanobanana"
...
PROMPTS: list[dict[str, str]] = [
    {
        "name": "ai-displacement-timeline-stack-2026.png",
        "title": "AI Displacement Timeline Stack",
        "prompt": (
            "Create a 16:9 editorial timeline titled 'The AI Displacement Timeline'. "
            "Show six stages from left to right: 'task exposure', 'workflow automation', 'hiring slowdown', "
            "'wage pressure', 'role redesign', and 'visible displacement'. Add a lower band labeled "
            "'household wealth risk starts before layoffs'. Use restrained blue, slate, and amber accents."
        ),
    },
    {
        "name": "ai-displacement-household-risk-map-2026.png",
        "title": "AI Displacement Household Risk Map",
        "prompt": (
            "Create a 16:9 editorial systems map titled 'From AI Task Exposure to Household Wealth Risk'. "
            "Place 'AI task compression' in the center. Connect it to 'fewer junior roles', 'weaker outside offers', "
            "'slower wage growth', 'retraining cost', and 'liquidity runway'. End with a right-side box labeled "
            "'bargaining power determines damage'. Use clean arrows and compact labels."
        ),
    },
]
