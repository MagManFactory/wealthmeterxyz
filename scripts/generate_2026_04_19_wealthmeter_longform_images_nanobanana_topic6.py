#!/usr/bin/env python3
"""Generate Nano Banana Pro visuals for the 2026-04-19 WealthMeter topic-6 refresh."""
...
ARTIFACT_DIR = ROOT / "output" / "review" / "longform-pair-2026-04-19" / "wealthmeter-nanobanana"
...
PROMPTS: list[dict[str, str]] = [
    {
        "name": "asset-rich-cash-poor-conversion-ladder-2026.png",
        "title": "Asset Rich Cash Poor Conversion Ladder",
        "prompt": (
            "Create a 16:9 editorial ladder titled "
            "'Wealth Layers Fail on Different Clocks'. "
            "Use six horizontal tiers labeled 'cash', 'Treasury-like reserves', "
            "'taxable diversified assets', 'retirement wrappers', 'home equity', and "
            "'private business value'. Add three narrow columns on the right labeled "
            "'time to use', 'friction', and 'strategic damage'. Show blue for strong immediate defense, "
            "slate for moderate conversion, and restrained amber for slow or costly conversion."
        ),
    },
    {
        "name": "asset-rich-cash-poor-choice-erosion-map-2026.png",
        "title": "Asset Rich Cash Poor Choice Erosion Map",
        "prompt": (
            "Create a 16:9 editorial decision map titled "
            "'Illiquid Wealth Shrinks Household Choice'. "
            "Begin with three origin boxes labeled 'job interruption', 'relocation need', and "
            "'expense cluster'. Route them through constraint boxes labeled 'sell into drawdown', "
            "'borrow against home', 'tap retirement early', and 'delay decision'. End with four outcome boxes "
            "labeled 'less bargaining power', 'career optionality loss', 'forced sale risk', and "
            "'future compounding damage'. Keep the design institutional and highly legible."
        ),
    },
]
