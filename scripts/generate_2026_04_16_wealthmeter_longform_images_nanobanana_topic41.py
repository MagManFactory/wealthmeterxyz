#!/usr/bin/env python3
"""Generate Nano Banana Pro visuals for the 2026-04-16 WealthMeter topic-41 longform article."""
...
PROMPTS: list[dict[str, str]] = [
    {
        "name": "rich-not-famous-income-map.png",
        "title": "Rich but Not Famous Income Map",
        "prompt": (
            "Create a 16:9 editorial map titled "
            "'The Rich but Not Famous Economy'. "
            "Show a small top-right cluster labeled 'celebrities and public founders' and a much larger quiet field labeled "
            "'private business owners', 'professional partners', 'senior executives', "
            "'regional operators', and 'family capital'. "
            "Use arrows showing why public attention overweights the small cluster. "
            "Keep the design crisp, institutional, and highly legible."
        ),
    },
    {
        "name": "rich-not-famous-wealth-stack.png",
        "title": "Rich but Not Famous Wealth Stack",
        "prompt": (
            "Create a 16:9 layered editorial diagram titled "
            "'Where Quiet Wealth Actually Sits'. "
            "Use stacked horizontal layers labeled 'private business equity', 'partnership income', "
            "'executive equity and deferred comp', 'regional real assets', and 'family capital'. "
            "Place a thinner visible ribbon above them labeled 'celebrity and public-market visibility'. "
            "Use blue, slate, and teal with restrained amber highlights. "
            "All labels must be large and publication-ready."
        ),
    },
]
