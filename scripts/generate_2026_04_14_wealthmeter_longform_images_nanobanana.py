#!/usr/bin/env python3
"""Generate Nano Banana Pro visuals for the 2026-04-14 WealthMeter longform article."""
...
ARTIFACT_DIR = ROOT / "output" / "review" / "longform-pair-2026-04-14" / "wealthmeter-nanobanana"
...
PROMPTS: list[dict[str, str]] = [
    {
        "name": "mobility-premium-option-value-grid.png",
        "title": "Mobility Premium Option Value Grid",
        "prompt": (
            "Create a 16:9 editorial infographic titled "
            "'The Mobility Premium'. "
            "Show a two-column option-value grid comparing 'mobile household' and 'anchored household' "
            "across rows labeled 'job negotiation', 'housing reset', 'cost-of-living arbitrage', "
            "'shock response', and 'family relocation flexibility'. "
            "Use blue and teal with one restrained amber accent on friction costs. "
            "Keep the design institutional, clean, and highly legible."
        ),
    },
    {
        "name": "mobility-premium-friction-map.png",
        "title": "Mobility Premium Friction Map",
        "prompt": (
            "Create a 16:9 systems map titled "
            "'What Erodes The Mobility Premium'. "
            "Put 'mobility premium' in the center and surround it with friction nodes labeled "
            "'mortgage lock-in', 'job-linked benefits', 'transaction costs', 'school and care obligations', "
            "'concentrated local assets', and 'thin cash runway'. "
            "Show arrows from each friction node reducing bargaining power, geographic arbitrage, and exit options. "
