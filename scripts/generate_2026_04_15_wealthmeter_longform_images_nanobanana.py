#!/usr/bin/env python3
"""Generate Nano Banana Pro visuals for the 2026-04-15 WealthMeter longform article."""
...
ARTIFACT_DIR = ROOT / "output" / "review" / "longform-pair-2026-04-15" / "wealthmeter-nanobanana"
...
PROMPTS: list[dict[str, str]] = [
    {
        "name": "liquidity-illusion-liquidity-ladder-2026-refresh.png",
        "title": "Liquidity Illusion Conversion Ladder",
        "prompt": (
            "Create a 16:9 editorial infographic titled "
            "'The Liquidity Ladder'. "
            "Show a vertical ladder ranking balance-sheet layers from top to bottom: "
            "'cash', 'Treasury bills and money markets', 'diversified taxable securities', "
            "'pledged collateral and credit lines', 'retirement accounts', 'home equity', "
            "'and private business value'. "
            "Add three compact scoring columns on the right labeled 'speed', 'certainty', and 'friction'. "
            "Use blue and slate with a restrained amber accent for higher-friction layers. "
            "Keep the layout institutional, crisp, and highly legible."
        ),
    },
    {
        "name": "liquidity-illusion-optionality-grid-2026-refresh.png",
        "title": "Liquidity And Optionality Grid",
        "prompt": (
            "Create a 16:9 editorial decision grid titled "
            "'Which Liquidity Layer Protects Which Decision'. "
            "Use columns labeled 'owned liquidity', 'market liquidity', 'collateral liquidity', and 'locked capital'. "
            "Use rows labeled 'cover job loss', 'relocate fast', 'negotiate a better offer', "
            "'avoid forced asset sales', and 'support a family shock'. "
            "Show strong-fit cells in blue, weak-fit cells in light gray, and risky-fit cells in restrained amber. "
            "Use a minimalist editorial style with large readable labels."
        ),
    },
]
