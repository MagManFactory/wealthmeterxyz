#!/usr/bin/env python3
"""Generate Nano Banana Pro visuals for the 2026-05-04 WealthMeter topic-28 article."""
...
ARTIFACT_DIR = ROOT / "output" / "review" / "longform-pair-2026-05-04" / "wealthmeter-nanobanana"
...
PROMPTS: list[dict[str, str]] = [
    {
        "name": "geographic-arbitrage-spread-map-2026-may04.png",
        "title": "Geographic Arbitrage Spread Map",
        "prompt": (
            "Create a 16:9 editorial spread map titled 'The Geographic Arbitrage Window'. "
            "Show two large zones labeled 'income market' and 'cost market'. "
            "Between them place arrows for 'remote portability', 'housing spread', 'tax spread', and 'mobility friction'. "
            "Use a highlighted central band labeled 'arbitrage window'. "
            "Add concise side notes: 'earnings stay premium', 'living costs reset lower', and 'window narrows as systems converge'."
        ),
    },
    {
        "name": "geographic-arbitrage-closing-forces-2026-may04.png",
        "title": "Geographic Arbitrage Closing Forces",
        "prompt": (
            "Create a 16:9 editorial compression diagram titled 'What Closes The Window'. "
            "Use five descending blocks labeled 'destination housing reprices', 'compensation localizes', 'tax and insurance rise', "
            "'family or ownership friction grows', and 'career-depth loss'. "
            "At the top place the label 'wide spread', and at the bottom place 'compressed spread'. "
