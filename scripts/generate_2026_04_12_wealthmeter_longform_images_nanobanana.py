#!/usr/bin/env python3
"""Generate Nano Banana Pro visuals for the 2026-04-12 WealthMeter longform article."""
...
ARTIFACT_DIR = ROOT / "output" / "review" / "longform-pair-2026-04-12" / "wealthmeter-nanobanana"
...
PROMPTS: list[dict[str, str]] = [
    {
        "name": "timing-fallacy-behavior-loop.png",
        "title": "Timing Fallacy Behavior Loop",
        "prompt": (
            "Create a 16:9 editorial systems infographic titled "
            "'The Timing Fallacy in Public Markets'. "
            "Use a circular behavior loop with six nodes labeled 'market drawdown', 'fear spike', "
            "'sell to feel safe', 'wait for clarity', 'recovery already underway', and 're-enter after reassurance'. "
            "Add a central label reading 'realized return drag'. "
            "Use blue and teal for the loop and one amber warning accent on the sell node. "
            "Include a footer note: 'The error is repeated reaction, not one bad forecast.'"
        ),
    },
    {
        "name": "public-market-discipline-stack.png",
        "title": "Public Market Discipline Stack",
        "prompt": (
            "Create a 16:9 layered framework graphic titled "
            "'What Replaces Market Timing'. "
            "Stack five horizontal layers labeled 'cash reserve', 'automated contributions', "
            "'target allocation', 'rebalance bands', and 'decision rules for real plan changes'. "
            "Add a right-side outcomes column with short phrases 'fewer forced sales', 'continuous participation', "
            "'risk budget stays visible', 'volatility becomes maintenance', and 'macro noise matters less'. "
            "Use a clean institutional style with blue and teal blocks on a white background."
        ),
    },
]
