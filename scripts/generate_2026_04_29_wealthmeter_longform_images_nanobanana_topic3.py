#!/usr/bin/env python3
"""Generate Nano Banana Pro visuals for the 2026-04-29 WealthMeter topic-3 article."""
...
ARTIFACT_DIR = ROOT / "output" / "review" / "longform-pair-2026-04-29" / "wealthmeter-nanobanana"
...
PROMPTS: list[dict[str, str]] = [
    {
        "name": "inflation-ladder-purchasing-power-stack-2026-apr29.png",
        "title": "Inflation Ladder Purchasing Power Stack",
        "prompt": (
            "Create a 16:9 editorial ladder diagram titled 'The Inflation Ladder Problem'. "
            "Show six upward rungs labeled 'cash balances', 'fixed coupons and annuities', 'wages and salary reviews', "
            "'rents and business revenue', 'tax and benefit adjustments', and 'debt reset structure'. "
            "Add small side notes on the rungs: 'instant erosion', 'nominal stability only', 'lagged renegotiation', "
            "'market and lease turnover', 'indexing mismatch', and 'fixed versus floating'. "
            "Footer: 'Inflation is a sequencing problem. Each rung of the household balance sheet resets on its own clock.'"
        ),
    },
    {
        "name": "inflation-ladder-asset-mismatch-grid-2026-apr29.png",
        "title": "Inflation Ladder Asset Mismatch Grid",
        "prompt": (
            "Create a 16:9 editorial matrix titled 'Fast Reset vs Slow Reset Purchasing Power'. "
            "Use horizontal axis 'reset speed slow to fast' and vertical axis 'inflation sensitivity low to high'. "
            "Place concise blocks for 'cash drag', 'nominal bond squeeze', 'fixed mortgage relief', 'floating debt risk', "
            "'wage lag', 'equity pricing power', and 'rent reset friction'. "
            "Highlight the center danger zone with the label 'mismatch trap'. "
            "Use restrained blue-gray styling with an amber emphasis for the mismatch zone."
        ),
    },
]
