#!/usr/bin/env python3
"""Generate Nano Banana Pro visuals for the 2026-05-05 WealthMeter topic-33 article."""
...
ARTIFACT_DIR = ROOT / "output" / "review" / "longform-pair-2026-05-05" / "wealthmeter-nanobanana"
...
PROMPTS = [
    {
        "name": "comparison-trap-reference-escalator-2026-may05.png",
        "title": "Comparison Trap Reference Escalator",
        "prompt": (
            "Create a 16:9 editorial escalator diagram titled 'The Comparison Trap in the Digital Age'. "
            "Show four upward steps labeled 'local peers', 'successful acquaintances', 'curated affluent feeds', and 'performative upper tail'. "
            "On the right add descending labels for 'felt adequacy' and ascending labels for 'status pressure'. "
            "Include a footer note: 'The benchmark shifts upward faster than the balance sheet.'"
        ),
    },
    {
        "name": "comparison-trap-balance-sheet-gap-2026-may05.png",
        "title": "Comparison Trap Balance Sheet Gap",
        "prompt": (
            "Create a 16:9 editorial matrix titled 'Visible Lifestyle vs Hidden Financial Reality'. "
            "Use two columns labeled 'what people see' and 'what they usually do not see'. "
            "Rows should read 'house', 'travel', 'schooling', 'portfolio', and 'career freedom'. "
            "In the hidden column add concise tags such as 'mortgage load', 'inheritance support', 'liquidity buffer', 'debt service', and 'income durability'. "
