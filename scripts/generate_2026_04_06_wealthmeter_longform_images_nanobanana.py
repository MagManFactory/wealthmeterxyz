#!/usr/bin/env python3
"""Generate Nano Banana Pro visuals for the 2026-04-06 WealthMeter longform article."""
...
ARTIFACT_DIR = ROOT / "output" / "review" / "longform-pair-2026-04-06" / "wealthmeter-nanobanana"
...
PROMPTS: list[dict[str, str]] = [
    {
        "name": "cost-of-capital-hurdle-stack.png",
        "title": "Cost of Capital Hurdle Stack",
        "prompt": (
            "Create a 16:9 editorial systems infographic titled "
            "'The Cost-of-Capital Trap'. "
            "Use a stacked-layer diagram rising upward. "
            "Base layer label: 'headline borrowing rate'. "
            "Second layer: 'credit spread or equity risk premium'. "
            "Third layer: 'tax drag and fees'. "
            "Fourth layer: 'liquidity lock-up'. "
            "Top layer: 'execution and refinancing risk'. "
            "Add a side annotation column with 'housing', 'private markets', and 'business investment' pointing to the full stack. "
            "Footer note: 'Capital only works when returns clear the full hurdle, not only the visible rate.'"
        ),
    },
    {
        "name": "cost-of-capital-allocation-grid.png",
        "title": "Cost of Capital Allocation Grid",
        "prompt": (
            "Create a 16:9 decision grid titled "
            "'Which Assets Clear The Real Hurdle?'. "
            "Use a 2x2 matrix. Horizontal axis: 'apparent return low' to 'apparent return high'. "
            "Vertical axis: 'hidden capital friction low' to 'hidden capital friction high'. "
            "Top-left quadrant label: 'safe but low spread'. "
            "Top-right quadrant label: 'genuine spread' with notes 'clear hurdle', 'liquid enough'. "
            "Bottom-left quadrant label: 'cash with option value'. "
            "Bottom-right quadrant label: 'trap zone' with notes 'illiquidity', 'refinancing risk', 'maintenance drag', 'dilution risk'. "
            "Footer strip: 'A high headline return can still fail once the real cost of capital is priced honestly.'"
        ),
    },
]
