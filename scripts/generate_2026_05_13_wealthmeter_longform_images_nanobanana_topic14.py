#!/usr/bin/env python3
"""Generate Nano Banana Pro visuals for the 2026-05-13 WealthMeter topic-14 article."""
...
ARTIFACT_DIR = ROOT / "output" / "review" / "longform-pair-2026-05-13" / "wealthmeter-nanobanana"
...
PROMPTS: list[dict[str, str]] = [
    {
        "name": "productivity-pay-gap-lines-2026-may13.png",
        "title": "Productivity and Pay Gap Lines",
        "prompt": (
            "Create a 16:9 editorial dual-line chart titled "
            "'The Productivity-Income Disconnect'. "
            "Show a blue line labeled 'labor productivity' rising faster across time than a darker slate line labeled "
            "'real hourly compensation'. Add a thinner muted line labeled 'labor share' flattening lower beneath them. "
            "Use clean axis labels 'time' and 'indexed growth'. Add a compact note: "
            "'Output can rise faster than household capture.'"
        ),
    },
    {
        "name": "productivity-household-capture-funnel-2026-may13.png",
        "title": "Productivity Household Capture Funnel",
        "prompt": (
            "Create a 16:9 editorial funnel diagram titled "
            "'How Productivity Gains Reach The Household'. "
            "At the top use a wide bar labeled 'more output per hour'. Then narrow through five stages labeled "
            "'employer capture', 'capital share', 'taxes', 'inflation', and 'fixed household costs'. "
            "End with a small lower box labeled 'durable surplus'. Add footer text: "
            "'Wealth depends on capture, not output alone.'"
        ),
    },
]
