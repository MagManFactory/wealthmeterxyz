#!/usr/bin/env python3
"""Generate Nano Banana Pro visuals for the 2026-05-02 WealthMeter topic-18 article."""
...
ARTIFACT_DIR = ROOT / "output" / "review" / "longform-pair-2026-05-02" / "wealthmeter-nanobanana"
...
PROMPTS: list[dict[str, str]] = [
    {
        "name": "private-markets-premium-haircut-2026-may02.png",
        "title": "Private Markets Premium Haircut",
        "prompt": (
            "Create a 16:9 editorial waterfall titled "
            "'The Claimed Premium Is Not the Net Investor Premium'. "
            "Start with a tall blue bar labeled 'marketed private premium'. "
            "Then show descending deduction bars labeled 'management fees and carry', 'valuation lag', "
            "'leverage and financing cost', 'tax friction', and 'lost liquidity option'. "
            "End with a final dark bar labeled 'net premium that survives'."
        ),
    },
    {
        "name": "private-markets-liquidity-access-grid-2026-may02.png",
        "title": "Private Markets Access and Liquidity Grid",
        "prompt": (
            "Create a 16:9 editorial comparison grid titled "
            "'Access Changes the Economics of Private Markets'. "
            "Use three columns labeled 'institutional direct access', 'wrapper or feeder access', and "
            "'liquid public substitute'. Use four rows labeled 'fees', 'liquidity', 'valuation clarity', "
            "and 'control'. Fill cells with short phrases such as 'negotiated', 'layered fees', "
            "'quarterly marks', 'daily price', 'capital calls', and 'immediate rebalance'."
        ),
    },
]
