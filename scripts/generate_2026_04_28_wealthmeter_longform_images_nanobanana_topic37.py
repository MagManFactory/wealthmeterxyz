#!/usr/bin/env python3
"""Generate Nano Banana Pro visuals for the 2026-04-28 WealthMeter topic-37 article."""
...
PROMPTS: list[dict[str, str]] = [
    {
        "name": "loss-aversion-tax-decision-chain-2026-apr28.png",
        "title": "Loss Aversion Tax Decision Chain",
        "prompt": (
            "Create a 16:9 editorial process diagram titled 'The Loss Aversion Tax'. "
            "Show a left-to-right decision chain with six stages: 'paper loss', 'delay sale', "
            "'narrative defense', 'capital stays trapped', 'better alternatives missed', and 'forced later realization'. "
            "Add small side tags under the chain: 'tax harvesting skipped', 'rebalancing delayed', and 'identity protection'. "
            "Footer: 'The main cost is rarely the first loss. It is the chain of distorted decisions that follows.'"
        ),
    },
    {
        "name": "loss-aversion-tax-balance-sheet-grid-2026-apr28.png",
        "title": "Loss Aversion Tax Balance Sheet Grid",
        "prompt": (
            "Create a 16:9 editorial matrix titled 'Where Loss Aversion Taxes Wealth'. "
            "Use a 2x2 grid. Horizontal axis: 'discipline weak' to 'discipline strong'. "
            "Vertical axis: 'capital flexibility low' to 'capital flexibility high'. "
            "Quadrant labels: 'trapped loser', 'tax-aware reset', 'panic de-risking', and 'governed reallocation'. "
            "Add short callouts such as 'breakeven anchor', 'opportunity cost', 'myopic review', and 'replacement logic'. "
            "Footer: 'The hidden tax shows up in rebalancing, taxes, optionality, and portfolio quality at the same time.'"
        ),
    },
]
