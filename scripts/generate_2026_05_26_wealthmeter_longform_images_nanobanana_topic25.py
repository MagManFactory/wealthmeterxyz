#!/usr/bin/env python3
"""Generate Nano Banana Pro visuals for the 2026-05-26 WealthMeter topic-25 article."""
...
ARTIFACT_DIR = ROOT / "output" / "review" / "longform-pair-2026-05-26" / "wealthmeter-nanobanana"
...
PROMPTS: list[dict[str, str]] = [
    {
        "name": "global-housing-divergence-regime-grid-2026-may26.png",
        "title": "Global Housing Divergence Regime Grid",
        "prompt": (
            "Create a 16:9 editorial comparison grid titled "
            "'Four Housing Regimes, Four Different Risks'. "
            "Use columns labeled 'supply-constrained global city', 'fixed-rate lock-in market', "
            "'buildable growth corridor', and 'demographic slowdown market'. "
            "Use rows labeled 'rate sensitivity', 'supply flexibility', 'affordability strain', and 'mobility friction'. "
            "Keep labels concise, bold, and publication-ready. "
            "Add a footer note reading 'global housing is now a set of regimes, not one synchronized trade'."
        ),
    },
    {
        "name": "housing-affordability-transmission-map-2026-may26.png",
        "title": "Housing Affordability Transmission Map",
        "prompt": (
            "Create a 16:9 editorial systems map titled "
            "'How Housing Divergence Actually Forms'. "
            "Start with five left-side inputs labeled 'policy rates', 'mortgage structure', 'new supply', 'migration', and 'local policy'. "
            "Route them through middle nodes labeled 'monthly payment', 'turnover', 'rent pressure', and 'inventory'. "
            "End with right-side outcomes labeled 'affordability', 'price resilience', 'liquidity', and 'household optionality'. "
            "Use simple arrows and clean spacing. "
            "Add a side note reading 'prices are only one output of the housing system'."
        ),
    },
]
