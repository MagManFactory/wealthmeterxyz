#!/usr/bin/env python3
"""Generate Nano Banana Pro visuals for the 2026-03-31 WealthMeter longform article.

Usage:
  GOOGLE_API_KEY=... python3 scripts/generate_2026_03_31_wealthmeter_longform_images_nanobanana.py
  python3 scripts/generate_2026_03_31_wealthmeter_longform_images_nanobanana.py --api-key "<GOOGLE_API_KEY>"
"""
...
ARTIFACT_DIR = ROOT / "output" / "review" / "longform-pair-2026-03-31" / "wealthmeter-nanobanana"
...
PROMPTS: list[dict[str, str]] = [
    {
        "name": "career-optionality-stack.png",
        "title": "Career Optionality Stack",
        "prompt": (
            "Create a 16:9 executive infographic titled "
            "'The Career Optionality Gap'. "
            "Use four stacked layers from bottom to top labeled "
            "'Liquid reserves', 'Transferable skills', 'Labor-market demand', and 'Work-design flexibility'. "
            "Add a top cap labeled 'Career optionality'. "
            "Next to each layer add short notes: "
            "'time to search', "
            "'multiple buyers for labor', "
            "'credible external offers', "
            "'schedule control and mobility'. "
            "Footer statement: 'Optionality is built, not declared.'"
        ),
    },
    {
        "name": "career-mobility-friction-map.png",
        "title": "Career Mobility Friction Map",
        "prompt": (
            "Create a 16:9 systems infographic titled "
            "'What Narrows Career Mobility'. "
            "Use a central box labeled 'Job transition'. "
            "Place four red friction boxes around it labeled "
            "'low savings', 'rigid schedule', 'benefit dependence', 'thin hiring market'. "
            "Place four blue relief boxes around it labeled "
            "'cash runway', 'portable credentials', 'self-paced work', 'multiple employers hiring'. "
            "Use arrows to show friction narrowing options and relief widening options. "
            "Editorial white background, crisp layout, no decorative clutter."
        ),
    },
]
