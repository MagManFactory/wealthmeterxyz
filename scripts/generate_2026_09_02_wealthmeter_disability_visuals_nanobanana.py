...
ARTIFACT_DIR = ROOT / "output" / "review" / "longform-pair-2026-09-02" / "wealthmeter-nanobanana"
...
PROMPTS: list[dict[str, str]] = [
    {
        "name": "disability-income-gap-2026-sep02.png",
        "title": "Disability Income Protection Gap",
        "prompt": (
            "Create a 16:9 editorial systems diagram titled 'Income Protection Is A Cash-Flow Sequence'. "
            "Show four connected blocks labeled employer coverage, waiting period, benefit terms, and liquid reserves. "
            "Include an essential-expenses line beneath the sequence."
        ),
    },
    {
        "name": "disability-cashflow-bridge-2026-sep02.png",
        "title": "Disability Cash-Flow Bridge",
        "prompt": (
            "Create a 16:9 editorial timeline titled 'Map the Income Interruption Before It Happens'. "
            "Show a sequence labeled work interruption, elimination period, benefit start, cash reserve draw, and reassessment. "
            "Use a clear monthly essential-expenses band across the full timeline."
        ),
    },
]
