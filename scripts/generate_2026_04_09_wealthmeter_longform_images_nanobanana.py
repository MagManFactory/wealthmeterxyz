#!/usr/bin/env python3
"""Generate Nano Banana Pro visuals for the 2026-04-09 WealthMeter longform article."""
...
ARTIFACT_DIR = ROOT / "output" / "review" / "longform-pair-2026-04-09" / "wealthmeter-nanobanana"
...
PROMPTS: list[dict[str, str]] = [
    {
        "name": "illiquidity-premium-claim-stack.png",
        "title": "Illiquidity Premium Claim Stack",
        "prompt": (
            "Create a 16:9 editorial systems infographic titled "
            "'The Illiquidity Premium Myth'. "
            "Use a descending stacked claim diagram. "
            "Top label: 'claimed illiquidity premium'. "
            "Then show deduction layers labeled 'management and incentive fees', "
            "'stale marks and smoothed volatility', 'embedded leverage', "
            "'selection and sourcing advantage', and 'lost liquidity option'. "
            "At the bottom place 'net investor premium, if any'. "
            "Footer note: 'Lock-up does not guarantee compensation after structure and optionality are priced honestly.'"
        ),
    },
    {
        "name": "illiquidity-premium-reality-grid.png",
        "title": "Illiquidity Premium Reality Grid",
        "prompt": (
            "Create a 16:9 comparison grid titled "
            "'What Investors Actually Need To Compare'. "
            "Use four vertical columns labeled 'theoretical premium', 'gross private return', "
            "'net investor return', and 'liquidity option retained'. "
            "Under the first column place 'trading friction' and 'lock-up compensation'. "
            "Under the second place 'fund IRR' and 'valuation smoothing'. "
            "Under the third place 'after fees', 'after taxes', and 'after delays'. "
            "Under the fourth place 'cash flexibility', 'rebalancing ability', and 'distress-response capacity'. "
            "Footer strip: 'The relevant benchmark is liquid alternatives plus the option value of flexibility.'"
        ),
    },
]
