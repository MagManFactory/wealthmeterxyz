#!/usr/bin/env python3
"""Generate Nano Banana Pro visuals for the 2026-05-14 WealthMeter topic-19 article."""
...
ARTIFACT_DIR = ROOT / "output" / "review" / "longform-pair-2026-05-14" / "wealthmeter-nanobanana"
...
PROMPTS: list[dict[str, str]] = [
    {
        "name": "venture-power-law-outcome-funnel-2026-may14.png",
        "title": "Venture Power Law Outcome Funnel",
        "prompt": (
            "Create a 16:9 editorial funnel diagram titled "
            "'The Venture Capital Power Law Reality'. "
            "Start with a wide top band labeled 'many funded startups'. "
            "Narrow through stages labeled 'survive', 'scale', 'meaningful exit', and 'outlier winner'. "
            "Beside the funnel place a note reading 'most value pools at the tail'. "
            "Use blue-gray for the large early stages and one strong blue highlight for the outlier stage."
        ),
    },
    {
        "name": "venture-fund-selection-dispersion-grid-2026-may14.png",
        "title": "Venture Fund Selection Dispersion Grid",
        "prompt": (
            "Create a 16:9 editorial comparison grid titled "
            "'Why Manager Selection Dominates Venture Outcomes'. "
            "Use three columns labeled 'top-tier access', 'credible but ordinary', and 'weak access'. "
            "Use four rows labeled 'deal flow', 'ownership retention', 'fee drag', and 'liquidity burden'. "
            "Show each cell with readable bars or icons that clearly differentiate quality. "
            "Add footer text: 'category exposure is not the same as winner exposure'."
        ),
    },
]
