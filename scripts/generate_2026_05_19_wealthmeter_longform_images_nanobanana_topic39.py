#!/usr/bin/env python3
"""Generate Nano Banana Pro visuals for the 2026-05-19 WealthMeter topic-39 article."""
...
ARTIFACT_DIR = ROOT / "output" / "review" / "longform-pair-2026-05-19" / "wealthmeter-nanobanana"
...
PROMPTS: list[dict[str, str]] = [
    {
        ...
        "prompt": (
            ...
            "Show five horizontal layers labeled 'tax obligations', 'liquidity reserve', 'debt cleanup', "
            "'long-horizon capital', and 'discretionary use'. "
            "Add compact notes showing that sequence matters more than excitement. "
            "Add a footer note reading 'one-time money should not become permanent burn'."
        ),
    },
    {
        ...
        "prompt": (
            ...
            "Use columns labeled 'days 1 to 30', 'days 31 to 90', and 'after discipline is set'. "
            "Use rows labeled 'tax handling', 'lifestyle pressure', 'investment temptation', and 'family requests'. "
            "Keep labels large and publication-ready. "
            "Add a side note reading 'early speed turns temporary relief into permanent fragility'."
        ),
    },
]
