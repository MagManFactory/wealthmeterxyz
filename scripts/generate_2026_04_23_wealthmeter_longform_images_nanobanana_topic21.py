#!/usr/bin/env python3
"""Generate Nano Banana Pro visuals for the 2026-04-23 WealthMeter topic-21 refresh."""
...
ARTIFACT_DIR = ROOT / "output" / "review" / "longform-pair-2026-04-23" / "wealthmeter-nanobanana"
...
STYLE_BLOCK = (
    ...
    "No logos, no watermarks, no fake user-interface chrome, no photorealism. "
    "Landscape 16:9 format, publication quality, with labels large enough to read."
)

PROMPTS: list[dict[str, str]] = [
    {
        "name": "concentration-diversification-barbell-2026-refresh.png",
        ...
        "prompt": (
            ...
            "Use a barbell composition. Left side labeled 'Diversified core' with notes "
            "'broad exposure', 'high survivability', 'lower idiosyncratic risk'. "
            "Right side labeled 'Concentrated edge' with notes 'control or insight', "
            "'higher upside', 'higher drawdown risk'. Center hinge label: "
            "'Household balance sheet'. Under the hinge add four decision tags: "
            "'edge', 'liquidity', 'human-capital overlap', and 'exit discipline'. "
            "Footer: 'Concentration only earns its place when the household can survive being wrong.'"
        ),
    },
    {
        "name": "concentration-edge-decision-grid-2026-refresh.png",
        "title": "Concentration Edge Decision Grid",
        "prompt": (
            "Create a 16:9 decision matrix titled 'When Concentration Is Rational'. "
            "Use a 2x2 grid. Horizontal axis: 'edge weak' to 'edge strong'. "
            "Vertical axis: 'liquidity thin' to 'liquidity strong'. "
            "Top-right quadrant: 'possible concentration' with notes 'clear edge', 'cash runway', 'exit rules'. "
            "Top-left quadrant: 'diversify' with note 'no edge, cash available'. "
            "Bottom-right quadrant: 'reduce size' with note 'edge may exist, runway too thin'. "
            "Bottom-left quadrant: 'do not concentrate' with note 'story risk, forced-sale risk'. "
            "Footer: 'Tax friction is not edge. Employer stock can duplicate labor risk.'"
        ),
    },
]
