#!/usr/bin/env python3
"""Generate Nano Banana Pro visuals for the 2026-04-20 LifeMeter topic-11 refresh."""
...
ARTIFACT_DIR = ROOT / "output" / "review" / "longform-pair-2026-04-20" / "lifemeter-nanobanana"
...
PROMPTS: list[dict[str, str]] = [
    {
        "name": "crm-human-evidence-stack-2026.png",
        "title": "Calorie Restriction Mimetics Human Evidence Stack",
        "prompt": (
            "Create a 16:9 editorial evidence stack titled "
            "'Caloric Restriction Mimetics: What Actually Works in Humans'. "
            "Use five horizontal tiers from top to bottom labeled 'calorie restriction itself', "
            "'low-dose mTOR modulation', 'metformin', 'spermidine and urolithin A', and "
            "'preclinical-only enthusiasm'. Add small side notes reading 'broad human metabolic signal', "
            "'bounded immune-aging signal', 'disease use with incomplete aging proof', "
            "'narrow endpoint signal', and 'mechanism without human translation'. "
            "Footer statement: 'Human endpoint breadth matters more than pathway prestige.'"
        ),
    },
    {
        "name": "crm-human-domain-boundaries-2026.png",
        "title": "Calorie Restriction Mimetic Domain Boundaries",
        "prompt": (
            "Create a 16:9 editorial matrix titled "
            "'Where Human Mimetic Signal Exists'. "
            "Use five columns labeled 'metformin', 'mTOR modulation', 'spermidine', "
            "'urolithin A', and 'NAD-linked compounds'. Use four rows labeled 'metabolic control', "
            "'immune resilience', 'muscle or mitochondrial function', and 'broad aging delay'. "
            "Mark the first three rows with selective colored signal blocks where appropriate, and keep the "
            "final row mostly empty with a bold note reading 'not established in healthy humans'."
        ),
    },
]
